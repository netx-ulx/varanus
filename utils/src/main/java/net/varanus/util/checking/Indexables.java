 ...
 */
package net.varanus.util.checking;
...
public final class Indexables
{
    /**
     * @param from
     *            The starting (inclusive) index of a contiguous region of the
     *            indexable object (must be non-negative)
     * @param to
     *            The ending (exclusive) index of a contiguous region of the
     *            indexable object (must be at least
     *            {@code from} and at most {@code length})
     * @param length
     *            The length of the indexable object (<b>required to be
     *            non-negative</b> - undefined result if negative)
    ...
    // separate method in order to avoid the string concatenation in cases where
     ...
     *            indexable object (must be non-negative)
     * @param regionLen
     *            The length of the contiguous region of the indexable object
