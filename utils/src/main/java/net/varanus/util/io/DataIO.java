...
public final class DataIO
{
     ...
     * {@link #writeBytes(DataOutput, ByteBuffer, int, BufferOperation)
     ...
     */
    public static void writeBytes( DataOutput out, ByteBuffer buf ) throws IOWriteException
    {
     ...
     */
    public static void writeBytes( DataOutput out, ByteBuffer buf, int numBytes ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeBytes( DataOutput out, ByteBuffer buf, BufferOperation op ) throws IOWriteException
    {
     ...
     *                {@code numBytes} bytes available to write
     */
    public static void writeBytes( DataOutput out, ByteBuffer buf, int numBytes, BufferOperation op )
        throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeByte( DataOutput out, byte b ) throws IOWriteException
    {
        _write(out, b);
    }
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeChar( DataOutput out, char c, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeShort( DataOutput out, short s, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeMedium( DataOutput out, int m, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeInt( DataOutput out, int i, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeLong( DataOutput out, long eL, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeFloat( DataOutput out, float f, ByteOrder order ) throws IOWriteException
    {
     ...
     *             If an I/O error occurs while writing
     */
    public static void writeDouble( DataOutput out, double d, ByteOrder order ) throws IOWriteException
    {
     ...
     * <p>
     * Calling this method has the same effect as calling
     * {@link #readBytes(DataInput, ByteBuffer, int, BufferOperation)
     ...
     */
    public static void readBytes( DataInput in, ByteBuffer buf ) throws IOReadException
    {
     ...
     */
    public static void readBytes( DataInput in, ByteBuffer buf, int numBytes ) throws IOReadException
    {
     ...
     *             If an I/O error occurs while reading
     */
    public static void readBytes( DataInput in, ByteBuffer buf, BufferOperation op ) throws IOReadException
    {
     ...
     *                {@code numBytes} bytes available for storage
     */
    public static void readBytes( DataInput in, ByteBuffer buf, int numBytes, BufferOperation op )
        throws IOReadException
    {
        final int bufPos = buf.position();
        final int bufLim = buf.limit();
     ...
     *             If an I/O error occurs while reading
     */
    public static byte readByte( DataInput in ) throws IOReadException
    {
        return _read(in);
    }
     ...
     *             If an I/O error occurs while reading
     */
    public static char readChar( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.CHAR);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static short readShort( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.SHORT);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static int readMedium( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.MEDIUM);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static int readInt( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.INT);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static long readLong( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.LONG);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static float readFloat( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.FLOAT);
        readFully(in, buf);
     ...
     *             If an I/O error occurs while reading
     */
    public static double readDouble( DataInput in, ByteOrder order ) throws IOReadException
    {
        ByteBuffer buf = tinyBuffer(SizeOf.DOUBLE);
        readFully(in, buf);
    ...
    private static void writeFully( DataOutput out, ByteBuffer buf ) throws IOWriteException
    {
        if (buf.hasArray()) {
            ...
            while (buf.hasRemaining()) {
                ...
                tmp.clear();
                ByteBuffers.copy(buf, tmp, batchSize); // buf's position
                                                       // advances
    ...
    private static void writeFullyFromArrayBacked( DataOutput out, ByteBuffer buf ) throws IOWriteException
    {
        byte[] arr = buf.array();
    ...
    private static void readFully( DataInput in, ByteBuffer buf ) throws IOReadException
    {
        if (buf.hasArray()) {
    ...
    private static void readFullyToArrayBacked( DataInput in, ByteBuffer buf ) throws IOReadException
    {
        byte[] arr = buf.array();
        int off = buf.position() + buf.arrayOffset();
        int len = buf.remaining();
        _read(in, arr, off, len);
    }

    private static void _write( DataOutput out, byte b ) throws IOWriteException
    {
        try {
            out.write(b);
        }
    ...
    private static void _write( DataOutput out, byte[] arr, int off, int len ) throws IOWriteException
    {
        try {
    ...
    private static byte _read( DataInput in ) throws IOReadException
    {
        try {
            return in.readByte();
        }
    ...
    private static void _read( DataInput in, byte[] arr, int off, int len ) throws IOReadException
    {
        try {
            in.readFully(arr, off, len);
        }
        catch (IOException e) {
            throw new IOReadException(e);
        }
