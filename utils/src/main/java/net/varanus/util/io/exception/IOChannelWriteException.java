 ...
 * 
 */
public class IOChannelWriteException extends IOWriteException
{
    private static final long serialVersionUID = 6882838707413489690L;

    public IOChannelWriteException( String message )
    {
        super(message, null);
    }

    public IOChannelWriteException( IOException cause )
    {
        super(cause);
    }

    public IOChannelWriteException( String message, IOException cause )
    {
        super(message, cause);
    }
